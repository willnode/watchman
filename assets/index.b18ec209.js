 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Te={upgradeDom:function(i,e){},upgradeElement:function(i,e){},upgradeElements:function(i){},upgradeAllRegistered:function(){},registerUpgradedCallback:function(i,e){},register:function(i){},downgradeElements:function(i){}};Te=function(){var i=[],e=[],n="mdlComponentConfigInternal_";function s(_,w){for(var C=0;C<i.length;C++)if(i[C].className===_)return typeof w<"u"&&(i[C]=w),i[C];return!1}function a(_){var w=_.getAttribute("data-upgraded");return w===null?[""]:w.split(",")}function c(_,w){var C=a(_);return C.indexOf(w)!==-1}function u(_,w,C){if("CustomEvent"in window&&typeof window.CustomEvent=="function")return new CustomEvent(_,{bubbles:w,cancelable:C});var T=document.createEvent("Events");return T.initEvent(_,w,C),T}function f(_,w){if(typeof _>"u"&&typeof w>"u")for(var C=0;C<i.length;C++)f(i[C].className,i[C].cssClass);else{var T=_;if(typeof w>"u"){var L=s(T);L&&(w=L.cssClass)}for(var B=document.querySelectorAll("."+w),G=0;G<B.length;G++)p(B[G],T)}}function p(_,w){if(!(typeof _=="object"&&_ instanceof Element))throw new Error("Invalid argument provided to upgrade MDL element.");var C=u("mdl-componentupgrading",!0,!0);if(_.dispatchEvent(C),!C.defaultPrevented){var T=a(_),L=[];if(w)c(_,w)||L.push(s(w));else{var B=_.classList;i.forEach(function(Fe){B.contains(Fe.cssClass)&&L.indexOf(Fe)===-1&&!c(_,Fe.className)&&L.push(Fe)})}for(var G=0,$=L.length,le;G<$;G++){if(le=L[G],le){T.push(le.className),_.setAttribute("data-upgraded",T.join(","));var at=new le.classConstructor(_);at[n]=le,e.push(at);for(var Mt=0,Tt=le.callbacks.length;Mt<Tt;Mt++)le.callbacks[Mt](_);le.widget&&(_[le.className]=at)}else throw new Error("Unable to find a registered component for the given class.");var ne=u("mdl-componentupgraded",!0,!1);_.dispatchEvent(ne)}}}function m(_){Array.isArray(_)||(_ instanceof Element?_=[_]:_=Array.prototype.slice.call(_));for(var w=0,C=_.length,T;w<C;w++)T=_[w],T instanceof HTMLElement&&(p(T),T.children.length>0&&m(T.children))}function b(_){var w=typeof _.widget>"u"&&typeof _.widget>"u",C=!0;w||(C=_.widget||_.widget);var T={classConstructor:_.constructor||_.constructor,className:_.classAsString||_.classAsString,cssClass:_.cssClass||_.cssClass,widget:C,callbacks:[]};if(i.forEach(function(B){if(B.cssClass===T.cssClass)throw new Error("The provided cssClass has already been registered: "+B.cssClass);if(B.className===T.className)throw new Error("The provided className has already been registered")}),_.constructor.prototype.hasOwnProperty(n))throw new Error("MDL component classes must not have "+n+" defined as a property.");var L=s(_.classAsString,T);L||i.push(T)}function v(_,w){var C=s(_);C&&C.callbacks.push(w)}function I(){for(var _=0;_<i.length;_++)f(i[_].className)}function S(_){if(_){var w=e.indexOf(_);e.splice(w,1);var C=_.element_.getAttribute("data-upgraded").split(","),T=C.indexOf(_[n].classAsString);C.splice(T,1),_.element_.setAttribute("data-upgraded",C.join(","));var L=u("mdl-componentdowngraded",!0,!1);_.element_.dispatchEvent(L)}}function A(_){var w=function(T){e.filter(function(L){return L.element_===T}).forEach(S)};if(_ instanceof Array||_ instanceof NodeList)for(var C=0;C<_.length;C++)w(_[C]);else if(_ instanceof Node)w(_);else throw new Error("Invalid argument provided to downgrade MDL nodes.")}return{upgradeDom:f,upgradeElement:p,upgradeElements:m,upgradeAllRegistered:I,registerUpgradedCallback:v,register:b,downgradeElements:A}}();Te.ComponentConfigPublic;Te.ComponentConfig;Te.Component;Te.upgradeDom=Te.upgradeDom;Te.upgradeElement=Te.upgradeElement;Te.upgradeElements=Te.upgradeElements;Te.upgradeAllRegistered=Te.upgradeAllRegistered;Te.registerUpgradedCallback=Te.registerUpgradedCallback;Te.register=Te.register;Te.downgradeElements=Te.downgradeElements;window.componentHandler=Te;window.componentHandler=Te;window.addEventListener("load",function(){"classList"in document.createElement("div")&&"querySelector"in document&&"addEventListener"in window&&Array.prototype.forEach?(document.documentElement.classList.add("mdl-js"),Te.upgradeAllRegistered()):(Te.upgradeElement=function(){},Te.register=function(){})});/**
 * @license
 * Copyright 2015 Google Inc. All Rights Reserved.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const IR=Math.log(2);class ER{constructor(e){const n=c=>parseInt(Math.log(c)/IR,10),s=c=>parseInt(Array(c+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const a=s(this.count);this.bits_=e+1&a}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const Ql=function(i,e,n,s){i.sort(e);const a=function(p,m){const b=m-p;let v,I;if(b===0)return null;if(b===1)return v=i[p],I=n?n(v):v,new tt(I,v.node,tt.BLACK,null,null);{const S=parseInt(b/2,10)+p,A=a(p,S),_=a(S+1,m);return v=i[S],I=n?n(v):v,new tt(I,v.node,tt.BLACK,A,_)}},c=function(p){let m=null,b=null,v=i.length;const I=function(A,_){const w=v-A,C=v;v-=A;const T=a(w+1,C),L=i[w],B=n?n(L):L;S(new tt(B,L.node,_,null,T))},S=function(A){m?(m.left=A,m=A):(b=A,m=A)};for(let A=0;A<p.count;++A){const _=p.nextBitIsOne(),w=Math.pow(2,p.count-(A+1));_?I(w,tt.BLACK):(I(w,tt.BLACK),I(w,tt.RED))}return b},u=new ER(i.length),f=c(u);return new It(s||e,f)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
